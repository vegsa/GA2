...
cont_gyro_noise_std =  5e-4 #4.36e-5  # (rad/s)/sqrt(Hz)
...
P_pred[0][POS_IDX ** 2] = np.eye(3)*100 # TODO
P_pred[0][VEL_IDX ** 2] = np.eye(3)*400 # TODO
P_pred[0][ERR_ATT_IDX ** 2] = np.eye(3)*0.02 # TODO # error rotation vector (not quat)
P_pred[0][ERR_ACC_BIAS_IDX ** 2] = np.eye(3)*0.01 # TODO
